...
function checkIfWin(){
	...
	if( !($('#box1').is(':empty'))  &&  $("#box1").attr("value") ===  $("#box4").attr("value")  &&  ($("#box4").attr("value") ===  $("#box7").attr("value")) ){
		...
		document.getElementById('speech-bubble-id').insertAdjacentHTML("afterbegin", $("#box1").attr("value") + " has won the game! " + "<a href='#' onclick='location.reload(true);'>Play Again</a>");
		...
		document.getElementById('speech-bubble-id').insertAdjacentHTML("afterbegin", $("#box2").attr("value") + " has won the game! " + "<a href='#' onclick='location.reload(true);'>Play Again</a>");
		...
		document.getElementById('speech-bubble-id').insertAdjacentHTML("afterbegin", $("#box3").attr("value") + " has won the game! " + "<a href='#' onclick='location.reload(true);'>Play Again</a>");
		...
		document.getElementById('speech-bubble-id').insertAdjacentHTML("afterbegin", $("#box4").attr("value") + " has won the game! " + "<a href='#' onclick='location.reload(true);'>Play Again</a>");
		...
		document.getElementById('speech-bubble-id').insertAdjacentHTML("afterbegin", "<div id='bubble-text'>" + $("#box7").attr("value") + " has won the game! " + "<a href='#' onclick='location.reload(true);'>Play Again</a>" + "</div>");
		...
		document.getElementById('speech-bubble-id').insertAdjacentHTML("afterbegin", "<div id='bubble-text'>" + $("#box1").attr("value") + " has won the game! " + "<a href='#' onclick='location.reload(true);'>Play Again</a>" + "</div>");
		document.getElementById("speech-bubble-modal-id").insertAdjacentHTML("afterbegin", $("#box1").attr("value") + " has won the game!");
		endTheGame();
		...
		document.getElementById('speech-bubble-id').insertAdjacentHTML("afterbegin", "<div id='bubble-text'>" + $("#box3").attr("value") + " has won the game! " + "<a href='#' onclick='location.reload(true);'>Play Again</a>" + "</div>");
		document.getElementById("speech-bubble-modal-id").insertAdjacentHTML("afterbegin", $("#box3").attr("value") + " has won the game!");
		endTheGame();
	} else {
		catsGame();
